...
relationships = [
    "DEFINES", "EXPLORES", "SOLVES", "DERIVES_FROM", 
    "IDENTIFIES", "ANALYZES_CAUSES", "EVALUATES_OPTIONS", 
    "PRIORITIZES_ISSUES", "GENERATES_HYPOTHESES", "VALIDATES_FINDINGS",
    "IMPLEMENTATION_DETAILS", "EVALUATES_EFFECTIVENESS", "ADAPTS_FROM", 
    "ADJUSTS_PARAMETERS", "REFINES_APPROACH", "APPLIES_TO_SCENARIO"
]
