...
template_process=[(
        ...
        ("human", "question must be correctly formatted,question_detail must be correctly formatted,keywords must be correctly formatted,solution must be correctly formatted,relationship must be correctly formatted"),
        ]
